...
--СТАТУС: WORK
--РЕАЛИЗАЦИЯ: Временные таблицы без Курсора 
--ПРОБЛЕМЫ: сверхсложный подсчёт времени
...
when cii0.OldGroupId IS NULL AND cii1.OldGroupId = cii1.NewGroupId AND cii2.OldGroupId = cii2.NewGroupId AND cii1.NewGroupId = cii2.OldGroupId then NULL
when cii0.OldGroupId IS NULL AND cii1.OldGroupId = cii1.NewGroupId AND cii2.OldGroupId = cii2.NewGroupId AND cii1.NewGroupId <> cii2.OldGroupId then cii1.NotChangingTime
when cii0.OldGroupId IS NULL AND cii1.OldGroupId <> cii1.NewGroupId AND cii2.OldGroupId = cii2.NewGroupId then cii1.NotChangingTime
...
when cii0.OldGroupId = cii0.NewGroupId AND cii1.OldGroupId <> cii1.NewGroupId AND cii2.OldGroupId = cii2.NewGroupId AND @PlusNotChangingTime IS NOT NULL then @PlusNotChangingTime + cii1.NotChangingTime --
when cii0.OldGroupId = cii0.NewGroupId AND cii1.OldGroupId <> cii1.NewGroupId AND cii2.OldGroupId = cii2.NewGroupId AND @PlusNotChangingTime IS NULL then cii0.NotChangingTime + cii1.NotChangingTime --
when cii0.OldGroupId = cii0.NewGroupId AND cii1.OldGroupId = cii1.NewGroupId AND cii2.OldGroupId IS NULL AND @PlusNotChangingTime IS NULL then cii0.NotChangingTime + cii1.NotChangingTime --
when cii0.OldGroupId = cii0.NewGroupId AND cii1.OldGroupId = cii1.NewGroupId AND cii2.OldGroupId IS NULL AND @PlusNotChangingTime IS NOT NULL then @PlusNotChangingTime + cii1.NotChangingTime --
when cii0.OldGroupId = cii0.NewGroupId AND cii1.OldGroupId = cii1.NewGroupId AND cii2.OldGroupId = cii2.OldGroupId AND @PlusNotChangingTime IS NULL then NULL --
when cii0.OldGroupId = cii0.NewGroupId AND cii1.OldGroupId = cii1.NewGroupId AND cii2.OldGroupId IS NULL AND @PlusNotChangingTime IS NOT NULL then @PlusNotChangingTime + cii1.NotChangingTime --
when cii0.OldGroupId = cii0.NewGroupId AND cii1.OldGroupId = cii1.NewGroupId AND cii2.OldGroupId <> cii2.OldGroupId AND @PlusNotChangingTime IS NOT NULL then NULL --
when cii0.OldGroupId = cii0.NewGroupId AND cii1.OldGroupId = cii1.NewGroupId AND cii2.OldGroupId <> cii2.OldGroupId AND @PlusNotChangingTime IS NULL then NULL --
...
when cii0.OldGroupId <> cii0.NewGroupId AND cii1.OldGroupId <> cii1.NewGroupId AND cii2.OldGroupId <> cii2.NewGroupId then cii1.NotChangingTime --
when cii0.OldGroupId <> cii0.NewGroupId AND cii1.OldGroupId = cii1.NewGroupId AND cii2.OldGroupId = cii2.NewGroupId AND cii1.OldGroupId = cii2.OldGroupId then NULL --
when cii0.OldGroupId <> cii0.NewGroupId AND cii1.OldGroupId = cii1.NewGroupId AND cii2.OldGroupId = cii2.NewGroupId AND cii1.OldGroupId <> cii2.OldGroupId then cii1.NotChangingTime --
...
when cii0.OldGroupId IS NULL AND cii1.OldGroupId = cii1.NewGroupId AND cii2.OldGroupId IS NULL then NULL --
when cii0.OldGroupId IS NULL AND cii1.OldGroupId = cii1.NewGroupId AND cii2.OldGroupId <> cii2.NewGroupId then NULL --
when cii0.OldGroupId IS NULL AND cii1.OldGroupId = cii1.NewGroupId AND cii2.OldGroupId = cii2.NewGroupId AND cii1.NewGroupId = cii2.OldGroupId then cii1.NotChangingTime
when cii0.OldGroupId IS NULL AND cii1.OldGroupId = cii1.NewGroupId AND cii2.OldGroupId = cii2.NewGroupId AND cii1.NewGroupId <> cii2.OldGroupId then NULL
when cii0.OldGroupId IS NULL AND cii1.OldGroupId <> cii1.NewGroupId AND cii2.OldGroupId = cii2.NewGroupId then NULL --
when cii0.OldGroupId = cii0.NewGroupId AND cii1.OldGroupId <> cii1.NewGroupId AND cii2.OldGroupId <> cii2.NewGroupId then NULL --
when cii0.OldGroupId = cii0.NewGroupId AND cii1.OldGroupId <> cii1.NewGroupId AND cii2.OldGroupId = cii2.NewGroupId AND @PlusNotChangingTime IS NOT NULL then NULL --
when cii0.OldGroupId = cii0.NewGroupId AND cii1.OldGroupId <> cii1.NewGroupId AND cii2.OldGroupId = cii2.NewGroupId AND @PlusNotChangingTime IS NULL then NULL --
when cii0.OldGroupId = cii0.NewGroupId AND cii1.OldGroupId = cii1.NewGroupId AND cii2.OldGroupId IS NULL AND @PlusNotChangingTime IS NULL then NULL --
when cii0.OldGroupId = cii0.NewGroupId AND cii1.OldGroupId = cii1.NewGroupId AND cii2.OldGroupId IS NULL AND @PlusNotChangingTime IS NOT NULL then NULL --
when cii0.OldGroupId = cii0.NewGroupId AND cii1.OldGroupId = cii1.NewGroupId AND cii2.OldGroupId = cii2.OldGroupId then cii1.NotChangingTime+@PlusNotChangingTime --
when cii0.OldGroupId = cii0.NewGroupId AND cii1.OldGroupId = cii1.NewGroupId AND cii2.OldGroupId <> cii2.OldGroupId AND @PlusNotChangingTime IS NOT NULL then cii1.NotChangingTime+@PlusNotChangingTime --
when cii0.OldGroupId = cii0.NewGroupId AND cii1.OldGroupId = cii1.NewGroupId AND cii2.OldGroupId <> cii2.OldGroupId AND @PlusNotChangingTime IS NULL then NULL --
when cii0.OldGroupId <> cii0.NewGroupId AND cii1.OldGroupId <> cii1.NewGroupId AND cii2.OldGroupId = cii2.NewGroupId then NULL --
when cii0.OldGroupId <> cii0.NewGroupId AND cii1.OldGroupId <> cii1.NewGroupId AND cii2.OldGroupId <> cii2.NewGroupId then NULL --
when cii0.OldGroupId <> cii0.NewGroupId AND cii1.OldGroupId = cii1.NewGroupId AND cii2.OldGroupId = cii2.NewGroupId AND cii1.OldGroupId = cii2.OldGroupId then cii1.NotChangingTime --
when cii0.OldGroupId <> cii0.NewGroupId AND cii1.OldGroupId = cii1.NewGroupId AND cii2.OldGroupId = cii2.NewGroupId AND cii1.OldGroupId <> cii2.OldGroupId then NULL --
when cii0.OldGroupId <> cii0.NewGroupId AND cii1.OldGroupId = cii1.NewGroupId AND cii2.OldGroupId <> cii2.NewGroupId then NULL --
when cii0.OldGroupId <> cii0.NewGroupId AND cii1.OldGroupId = cii1.NewGroupId AND cii2.OldGroupId IS NULL then NULL --
END 
