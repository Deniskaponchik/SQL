...
DECLARE cii_cur cursor global scroll for
...
DECLARE --@Countcii INT, 
	...
	, @NotChangingTime INT
/*SELECT --@Countcii = (SELECT COUNT(*) FROM #cii),@RowNumber = 1
	 @ServiceRequestId = NULL, @cii2_ServiceRequestId = NULL --, @cii_ServiceRequestId = NULL, @cii_ServiceRequestId = NULL
	,@CreatedOn = NULL --, @cii2_CreatedOn = NULL
	,@OldGroupId = NULL, @cii2_OldGroupId = NULL --, @cii_OldGroupId = NULL, @cii_OldGroupId = NULL
	,@NewGroupId = NULL, @cii2_NewGroupId = NULL --, @cii_NewGroupId = NULL, @cii_NewGroupId = NULL
	,@NotChangingTime = NULL*/
...
/*SELECT @Countcii = (SELECT COUNT(*) FROM #cii) --,@OldRowNumber = 1
	,@OldServiceRequestId = NULL ---, @cii_ServiceRequestId = NULL, @cii_ServiceRequestId = NULL, @cii2_ServiceRequestId = NULL
	--,@OldCreatedOn = NULL
	,@OldOldGroupId = NULL --, @cii_OldGroupId = NULL, @cii_OldGroupId = NULL, @cii2_OldGroupId = NULL
	,@OldNewGroupId = NULL --, @cii_NewGroupId = NULL, @cii_NewGroupId = NULL, @cii2_NewGroupId = NULL
	,@OldNotChangingTime = NULL*/
...
BEGIN
	...
	NotChangingTime = (case 
		when @OldServiceRequestId IS NULL AND @ServiceRequestID = @cii2_ServiceRequestId AND @OldGroupId = @NewGroupId AND @OldGroupId = @cii2_OldGroupId  then NULL --
		--when @OldServiceRequestId <> @ServiceRequestId AND @OldGroupId = @NewGroupId AND @OldGroupId = @cii2_OldGroupId  then NULL
	...
	@OldServiceRequestId = (case 
		...
		when @OldServiceRequestId <> @ServiceRequestId then @ServiceRequestId --
		end),
	*/
	NotChangingTime = @Countcii,
	@Countcii = @Countcii - 1 --
	--@OldRowNumber = @RowNumber + 1
	--INTO #cii FROM #cii

	WHERE RowNumber = @OldRowNumber

	SET @OldRowNumber = @RowNumber + 1 --SET @Countcii = @Countcii - 1
	/*SET 	@OldServiceRequestId = (case 
		when @OldServiceRequestId IS NULL then @ServiceRequestId --
		when @OldServiceRequestId <> @ServiceRequestId then @ServiceRequestId --
		end)*/
