--С использованием временных таблиц. Что-то пытается выполнять, но долго и безрезультатно.
...
SELECT 
   cii1.RowNumber RowNumber, cii1.CreatedOn CreatedOn,cii1.ServiceRequestId ServiceRequestId
