...
--INSERT INTO #SR (id, Number, RegisteredOn, ServiceRequestTypeId, ServiceId, TechServiceId, StatusOfIncidentId, SolutionDate, SolutionOverdue, ClosureDate)
	...
	FROM ServiceRequest
    WHERE 
	--ServiceRequestTypeId <> 'E8A1B4D7-9BA5-4BEF-8ED0-E7DB10E451BF' --Тип обращения не NOC
	--and RegisteredOn >= dateadd(day,-1,getdate())
	--and RegisteredOn > '2021-09-24 00:00:00' and RegisteredOn < '2021-09-24 23:59:59'
	--and RegisteredOn BETWEEN '2021-09-24 00:00:00' and '2021-09-24 23:59:59'
	      ClosureDate >= dateadd(day,-1,getdate())
	    --ClosureDate > '2021-09-24 00:00:00' and ClosureDate < '2021-09-24 23:59:59'
	    --ClosureDate > '2021-08-24 00:00:00' and ClosureDate < '2021-09-24 23:59:59'
